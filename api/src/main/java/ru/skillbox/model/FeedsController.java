...
public interface FeedsController {
    ...
    ResponseEntity<Responsable> getFeedsSearch(
    ...
    ResponseEntity<Responsable> getAllCommentsToPost(@PathVariable long id,
                                                     HttpServletRequest httpServletRequest)
    ...
    ResponseEntity<Responsable> getAllSubComments(@PathVariable long id, @PathVariable long commentId,
                                                  HttpServletRequest httpServletRequest)
            throws JsonProcessingException;
