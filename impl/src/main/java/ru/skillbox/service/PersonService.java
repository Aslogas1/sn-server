...
public class PersonService {
    ...
    @Autowired
    public PersonService(GeoService geoService, PersonRepository personRepository,
                         SettingRepository repositorySettings, MeterRegistry meterRegistry) {
        this.geoService = geoService;
        this.personRepository = personRepository;
        this.repositorySettings = repositorySettings;
        meterRegistry.gauge("peopleCount", personRepository.findAll().size());
    }
